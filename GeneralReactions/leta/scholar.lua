local tbl = 
{
	...
	
	{
		data = 
		{
			...
			uuid = "f107d072-6f29-bdd7-ab7b-a45d3694ccca",
			version = 2,
		},
		inheritedIndex = 9,
		inheritedObjectUUID = "1036d3a1-4cb1-3af6-bebb-b93a8a25f5fd",
		inheritedOverwrites = 
		{
		},
	},
	
	{
		...
		{
			name = "Custom Angles",
			uuid = "0826bf69-9f3f-1e54-977f-08904c69b0f0",
			version = 2,
		},
		inheritedIndex = 10,
	...
	
	{
		data = 
		{
			...
			uuid = "a22f8fb8-d125-645c-b6be-824a0951a449",
			version = 2,
		},
		inheritedIndex = 11,
	...
	
	{
		...
		{
			name = "Channels",
			uuid = "3d4c8c17-b9e3-d00f-817b-72176bd4ea49",
			version = 2,
		},
		inheritedIndex = 12,
	...
	
	{
		...
		{
			name = "Casts",
			uuid = "c40a4586-1aff-c349-9b0e-9859a74a02a8",
			version = 2,
		},
		inheritedIndex = 13,
	...
	
	{
		...
		{
			name = "Entity Add",
			uuid = "745f7cdc-4ccd-53e2-b68b-2acb04b0418f",
			version = 2,
		},
		inheritedIndex = 14,
	...
	
	{
		...
		{
			name = "Towers",
			uuid = "5662be09-3418-11ab-9d2c-38e97989da15",
			version = 2,
		},
		inheritedIndex = 15,
	...
	
	{
		...
		{
			name = "Gorai Tethers",
			uuid = "29e2ae43-3a00-18e2-a461-3e137b450717",
			version = 2,
		},
		inheritedIndex = 16,
	...
	
	{
		...
		{
			name = "Limit Cut",
			uuid = "cec55f40-2698-505c-bf2b-3ddf3ec594f1",
			version = 2,
		},
		inheritedIndex = 17,
	...
	
	{
		...
		{
			name = "AOEs",
			uuid = "3b09d3bf-3aae-e969-9866-7fcab87b61e7",
			version = 2,
		},
		inheritedIndex = 18,
	...
	
	{
		data = 
		{
			...
			uuid = "9bc8eb0a-bf4f-7c3f-8149-5e4caaa3b415",
			version = 2,
		},
		inheritedIndex = 19,
	...
	
	{
		...
		{
			name = "Moko Tethers",
			uuid = "d378f960-4a71-e6af-b36d-eda60cc7f49d",
			version = 2,
		},
		inheritedIndex = 20,
	...
	
	{
		data = 
		{
			...
			uuid = "b3e28ba1-32ad-e6ac-a19f-3981993d1146",
			version = 2,
		},
		inheritedIndex = 21,
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"b1f64540-9922-6245-8f17-8595fdc09c69",
								true,
							},
						},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						dequeueIfLuaFalse = true,
						name = "Buff - Swiftcast",
						uuid = "b1f64540-9922-6245-8f17-8595fdc09c69",
						version = 2,
					},
				},
			},
		...
		data = 
		{
			actions = 
			{
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"b59a07d3-55ea-8547-a696-4e7928e82a3e",
								true,
							},
						},
						endIfUsed = true,
						ignoreWeaveRules = true,
						name = "Consolation Pre-shielding",
						uuid = "f01ca2c4-1fad-f292-a682-3ab480afd707",
						version = 2,
					},
					inheritedIndex = 7,
				},
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"bc111275-451c-10db-a043-aec554966fec",
								true,
							},
				...
				
				{
					data = 
					{
						...
						uuid = "85f392eb-cfa7-dc3f-bb37-a32b3983d236",
						variableTogglesType = 3,
						version = 2,
					},
					inheritedIndex = 9,
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"365f4144-839e-87b9-8eb2-0824fdd7c308",
								true,
							},
						...
						endIfUsed = true,
						gVar = "ACR_RikuSCH2_Healbar_SacredAuto",
						targetType = "Detection Target",
			...
			conditions = 
			{
				...
				
				{
					...
					{
						category = "Lua",
						conditionLua = "return ACR_RikuSCH2_Recitation == true",
						dequeueIfLuaFalse = true,
						name = "Toggle Recitation",
						uuid = "9163192e-1540-d3b7-a284-b96fe8e329d8",
						version = 2,
					},
					inheritedIndex = 10,
				},
				...
				
				{
					data = 
					{
						...
						comparator = 2,
						conditionType = 4,
						name = "CD - Recitation <= 0s",
						uuid = "1b0b56e5-0159-83b0-88ee-421ecbc1766d",
						version = 2,
					},
					inheritedIndex = 24,
				},
				
				{
					data = 
					{
						...
						comparator = 2,
						conditionType = 4,
						name = "CD - Sacred Soil <= 0s",
						uuid = "365f4144-839e-87b9-8eb2-0824fdd7c308",
						version = 2,
					},
					inheritedIndex = 23,
				},
				...
				
				{
					data = 
					{
						...
						buffID = 1917,
						category = "Self",
						name = "Buff - Seraphic Veil",
						uuid = "b59a07d3-55ea-8547-a696-4e7928e82a3e",
						version = 2,
					},
					inheritedIndex = 50,
				},
				
				{
					data = 
					{
						...
						dequeueIfLuaFalse = true,
						name = "Buff - Swiftcast",
						uuid = "bc111275-451c-10db-a043-aec554966fec",
						version = 2,
					},
					inheritedIndex = 49,
				},
				...
				
				{
					data = 
					{
						...
						conditions = 
						{
							...
							{
								"6fc19a0c-f8b8-a8c4-b22e-6db7c1c9475b",
								true,
							},
			...
			conditions = 
			{
				...
				
				{
					data = 
					{
						...
						dequeueIfLuaFalse = true,
						name = "Buff - Swiftcast",
						uuid = "6fc19a0c-f8b8-a8c4-b22e-6db7c1c9475b",
						version = 2,
					},
					inheritedIndex = 6,
				},
	...
	
	{
		data = 
		{
			...
			eventType = 13,
			name = "Toggles",
			uuid = "ee9b9953-07cb-b71c-8187-7f27a6b90cbf",
			version = 2,
		},
		inheritedIndex = 32,
	},
